            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="產品資料" SortExpression="product_id">
                    ...
                    <ItemTemplate>
                        ...
                        <asp:DropDownList ID="DropDownList5" runat="server" DataSourceID="SqlDataSource4" DataTextField="product_item" DataValueField="product_id" EnableViewState="False">
                        </asp:DropDownList>
                        <asp:DropDownList ID="DropDownList6" runat="server" DataSourceID="SqlDataSource4" DataTextField="product_price" DataValueField="product_id" EnableViewState="False">
                        </asp:DropDownList>
                    </ItemTemplate>
                </asp:TemplateField>
